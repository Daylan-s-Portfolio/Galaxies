...
This project processes three JWST MIRI FITS images taken with filters **f770w**, **f1130w**, and **f1500w**. I build an RGB composite image from these three filters and perform additional data analyses to demonstrate my data science skills in R.
