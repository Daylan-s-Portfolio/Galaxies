...
This project processes three JWST MIRI FITS images taken with filters **f770w**, **f1130w**, and **f1500w**. I build an RGB composite image from these three filters and perform additional data analyses to demonstrate our data science skills in R. These extra analyses include:
...
\- Performing Principal Component Analysis (PCA) to explore dominant variations.
